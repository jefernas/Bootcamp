package com.liferay.training.gestion.pesonas.display.context;
 ...
 * @author liferay
 */
public class PersonasManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {
	
	public PersonasManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
...
// Create the menu.
	...
	/*return new CreationMenu() {
		{
			addDropdownItem(dropdownItem -> {dropdownItem.setHref(liferayPortletResponse.createRenderURL(),
					"mvcRenderCommandName", MVCCommandNames.ADD_PERSONAS, currentURLObj.toString());
					dropdownItem.setLabel(LanguageUtil.get(request, "add-personas"));
					});
		}
	};*/
}
	...
	public String getDisplayStyle() {
		...
		if (Validator.isNull(displayStyle)) {
			displayStyle = _portalPreferences.getValue(PersonasPortletKeys.PERSONAS, "personas-display-style",
					"descriptive");
		} else {
			_portalPreferences.setValue(PersonasPortletKeys.PERSONAS, "personas-display-style", displayStyle);
	...
	public String getSearchActionURL() {
		...
		searchURL.setProperty("mvcRenderCommandName", MVCCommandNames.VIEW_PERSONAS);
	...
	public List<ViewTypeItem> getViewTypeItems() {
		...
		portletURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_PERSONAS);
...
"mvcRenderCommandName", MVCCommandNames.VIEW_PERSONAS);
// Reset current page.
