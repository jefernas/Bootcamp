...
public class ViewPersonasMVCRenderCommand implements MVCRenderCommand {
	...
	private void addPersonasListAttributes(RenderRequest renderRequest) {
		...
		List<Personas> personas = 
				...
				//"personasCount", _personasService.getPersonasesCount(), //.getPersonasCountByKeywords(
	...
	/**
		...
		*/
		...
		LiferayPortletRequest liferayPortletRequest = _portal.getLiferayPortletRequest(renderRequest);//getLiferayPortletRequest(renderRequest);
		...
		renderRequest.setAttribute("personasManagementToolbarDisplayContext", personasManagementToolbarDisplayContext);
		}
